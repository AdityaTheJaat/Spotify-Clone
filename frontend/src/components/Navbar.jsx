...
import left from '../resources/angle-left.svg'
import right from '../resources/angle-right.svg'
  ...
  return (
    <div className='flex justify-between p-2 text-white bg-[#131618]'>
      <div className='flex items-center justify-center'>
        <Link to='/'>
          <img src={left} alt="" className='h-10 w-10 rounded-full bg-slate-900' />
        </Link>
        <Link to='/'>
          <img src={right} alt="" className='h-10 w-10 rounded-full bg-slate-900' />
        </Link>
      </div>
      {
        cookie.token ? (
          <div className='text-sm font-semibold flex justify-center items-center gap-5'>
            <Link to='/home' className='bg-white text-black rounded-3xl px-7 py-2'>Explore Premium</Link>
            <Link to='/' className='flex gap-2 bg-slate-700 rounded-3xl px-7 py-2'>
            ...
            <div className='bg-slate-500 text-black w-[1px]'>n</div>
            {
              matchRoute('/home/uploadSong') ? (
                    <Link to='/home/playlistsPage' className='flex bg-slate-700 rounded-3xl px-7 py-2'>
                      <p>Back to Home</p>
                    </Link>
                  ) : 
                  (
                    <Link to='/home/uploadSong' className='flex gap-2 bg-slate-700 rounded-3xl px-7 py-2'>
          ...
          (
            <div className='text-lg font-semibold flex justify-center items-center gap-5'>
              ...
              <Link to='/login' className='bg-white text-black rounded-3xl px-7 py-2'>Log in</Link>
            </div>
          )
      }
    </div>
